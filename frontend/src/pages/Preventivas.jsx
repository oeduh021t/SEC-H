...
const Preventivas = () => {
    ...
    // Controla qual card de status está ativo no filtro ('todos', 'emDia', 'criticas', 'atrasadas')
    const [filtroStatusCard, setFiltroStatusCard] = useState('todos');

    const API_URL = 'http://192.168.5.101:3000/api';

    // 🔑 AUXILIAR: Captura dinamicamente o privilégio operacional do operador
    ...
    const carregarDados = async () => {
        ...
        try {
            ...
            // 🛡️ Proteção contra Erro 500 ou respostas inválidas do servidor
    ...
    // 🔄 FILTRAGEM COMBINADA (Busca Global + Select + Cliques nos Cards)
    ...
    // CÁLCULO DOS TOTAIZADORES DO PAINEL SUPERIOR
    ...
    // 🛡️ TRATAMENTO PARA DATAS EM BRANCO/NULAS
                        ...
                        <tbody className="divide-y divide-slate-100 text-xs">
                            {dadosFiltrados.map(p => (
                                <tr key={p.id} className="hover:bg-slate-50/60 transition-colors">
                                    ...
                                    <td className="p-5">
                                        <div className="font-bold text-slate-700">{p.periodicidade_preventiva ? `${p.periodicidade_preventiva} dias` : 'Não programada'}</div>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <textarea 
                                    ...
                                    placeholder="Descreva detalhadamente as ações..."
                                ></textarea>
                            </div>
