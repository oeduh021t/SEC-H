...
const RelatorioFiltros = () => {
    ...
    return (
        <div className="p-6 bg-slate-50 min-h-screen font-sans text-slate-800">
            ...
            {/* CONTAINER ALVO DA IMPRESSÃO (O que o navegador vai enxergar) */}
            <div className="relatorio-container space-y-6">
                ...
                {loading ? (
                    ...
                    <>
                        {/* CARDS INDICADORES COESOS COM A IMPRESSÃO */}
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 indicadores-impressao">
                            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100">
                                ...
                                <p className="text-xl font-black text-slate-800 mt-1 print:text-sm">{dados?.indicadores?.total_trocas || 0} Unidades</p>
                            </div>
                            <div className="bg-white p-4 rounded-2xl shadow-sm border border-slate-100">
                                ...
                                <p className="text-xl font-black text-emerald-600 mt-1 print:text-sm">
                                    R$ {dados?.indicadores?.custo_total?.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                </p>
                            </div>
                        </div>
                                        ...
                                        {dados?.detalhes?.length === 0 ? (
                                            ...
                                            dados?.detalhes?.map((row) => (
                                                <tr key={row.id} className="text-xs hover:bg-slate-50/50 transition-colors print:text-[10px]">
                                                    ...
                                                    <td className="py-3.5">
                                                        <div className="font-black text-slate-700 uppercase">{row.filtro_name}</div>
