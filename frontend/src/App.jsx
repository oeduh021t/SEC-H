...
import Preventivas from './pages/Preventivas'; // Adicionado
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-7xl mx-auto">
            <Routes>
              ...
              {/* Fallback */}
              <Route path="*" element={<div className="p-10 text-center text-slate-400 font-bold">Página em desenvolvimento...</div>} />
            </Routes>
          </div>
        </main>
      </div>
